...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  30.99       // (Hz) The default dominant resonant frequency on the X axis.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 8*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
    ...
    #define X_AXIS_TWIST_COMPENSATION
      ...
      #define XATC_Z_OFFSETS { -0.10, 0.02, 0.08 }    // Z offsets for X axis sample points
    #endif
