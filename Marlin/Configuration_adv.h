...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.34 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.34        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
  ...
  #define PROBE_PT_1 {  45, 45 }   // (mm) { x, y }
  #define PROBE_PT_2 {  267,  45 }
  #define PROBE_PT_3 { 156,  261 }
#endif
