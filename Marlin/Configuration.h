...
#define STRING_CONFIG_H_AUTHOR "(Samuels, SKR 1.4 Turbo with 0.4)" // Original author or contributor.
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 52.3
  #define DEFAULT_bedKi 4.56
  #define DEFAULT_bedKd 399.5
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 400, 599.02 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25.1, -17.4, -3.53 }
