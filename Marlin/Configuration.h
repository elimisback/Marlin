...
#define STRING_CONFIG_H_AUTHOR "(Samuels, Ender-3 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -17.7, -49.2, -3.00 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 50.3, 50.3, 50.3, 50.3 } // (mm) Left, Front, Right, Back insets
